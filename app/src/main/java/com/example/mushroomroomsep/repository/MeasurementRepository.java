...
public class MeasurementRepository {
    ...
    private final MutableLiveData<Measurement> measurementListLiveData = new MutableLiveData<>();
    private final MutableLiveData<HumidityThreshold> humidityListLiveData = new MutableLiveData<>();
    private final MutableLiveData<LightThreshold> lightListLiveData = new MutableLiveData<>();
    private final MutableLiveData<Co2Threshold> co2ListLiveData = new MutableLiveData<>();
    private final MutableLiveData<TemperatureThreshold> temperatureListLiveData = new MutableLiveData<>();
